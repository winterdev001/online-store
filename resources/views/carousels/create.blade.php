                  ...
                  <section class="col-lg-12 connectedSortable" id="all_products">
                    <div class="card">
                        <div class="card-header">
                          <h3 class="card-title">Create Carousel</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                           {{-- content --}}
                            ...
                            {!! Form::open(['action'=>'CarouselsController@store','method'=>'POST','enctype'=>'multipart/form-data']) !!}
                                <div class="form-group">
                                    ...
                                    {{Form::text('first_title','',['class'=>'form-control','placeholder'=>'First Title'])}}
                                </div>
                                <div class="form-group">
                                    {{Form::label('second_title','Second Title')}}
                                    {{Form::text('second_title','',['class'=>'form-control','placeholder'=>'Second Title'])}}
                                </div>
                                <div class="form-group">
                                ...
                                {{Form::submit('Add Carousel',['class'=>'btn btn-primary'])}}
