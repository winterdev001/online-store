            ...
            <section class="content">
              <div class="container-fluid">
                ...
                <div class="row">
                  <!-- Left col -->
                  {{-- products --}}
                  <section class="col-lg-12 connectedSortable" id="all_carousels">
                    <div class="card">
                        <div class="card-header">
                          <h3 class="card-title">Carousel Details</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                           {{-- content --}}
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                <div class="card-body" >
                                    <p>Carousel First Title: {{$carousel->first_title}}</p>
                                    <p>Carousel Second Title: {{$carousel->second_title}}</p>
                                </div>

                                </div>
                                <div class="col-md-7">
                                <img style="width:100%" height="100%" src="/storage/carousels_images/{{$carousel->image}}" class="card-img"
                                    alt="{{$carousel->first_title}}">
                                </div>
                            </div>
                            </div>
                            <table>
